						...
						<tr key={user._id} className={currentUserStyle}>
							...
							<td className={table__cell}>
								{isCurrentUser ? (
									...
									<div
										...
										onClick={() => editUser(user, 'admin')}>
										<img
											src={user.admin ? CheckImage : NotCheckImage}
											alt='Checked'
										/>
									</div>
								)}
							...
							<td className={table__cell}>
								{isCurrentUser ? (
									...
									<div
										className={item__checkbox}
										onClick={() => editUser(user, 'active')}>
										<img
											src={user.active ? CheckImage : NotCheckImage}
											alt='Checked'
										/>
									</div>
								)}
							...
							<td className={table__cell}>
								{isCurrentUser ? (
									...
									<i
										className={`fas fa-trash ${item__icon}`}
...
const table__cell = css`min-width: 7rem;`
