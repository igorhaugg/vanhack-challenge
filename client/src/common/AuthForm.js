		...
		<main className={auth}>
			<div className={auth__greeting}>
				<div className={auth__greeting__conteiner}>
					...
					<p>
						This web application is a dashboard that allow admin users to manage
						tasks.
					</p>
				</div>
			</div>
...
const auth__message = css`margin-top: 2rem;`
...
const auth__greeting__conteiner = css`padding: 5rem;`
