  ...
  handleToggle = name => {
    if (name === 'password') {
      ...
      this.setState({
        ...
        password2Type: this.state.password2Type === 'password' ? 'text' : 'password'
      });
    }
  };
    ...
    return (
      <AuthForm titleText='Register' messageText='Já possui uma conta?'>
        <form onSubmit={this.onSubmit}>
          <InputItem label='name' name='name' value={this.state.name} onChange={this.onChange} error={error.name} required={true} />
